...
export default function WelcomeCard() {
  ...
  return (
    <div className="relative overflow-hidden m-3 rounded-2xl border border-gray-100 bg-gradient-to-br from-white to-gray-50 p-6 shadow-md transition-all hover:shadow-lg dark:border-gray-700 dark:from-gray-800 dark:to-gray-900 sm:p-8">
